...
unsigned int	ClapTrap::_initCTHitPoint = 10;
unsigned int	ClapTrap::_initCTEnergyPoint = 10;
unsigned int	ClapTrap::_initCTAttackDamage = 0;

ClapTrap::ClapTrap()
{
    this->_hitPoints = _initCTHitPoint;
    this->_energyPoints = _initCTEnergyPoint;
    this->_attackDamage = _initCTAttackDamage;
