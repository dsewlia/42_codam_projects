...
int main()
{
    ...
    while (1)
    {
        std::cout << "\n1:  Create Bureaucrat\n"
				  ...
				  << "19: Create Form via Intern\n"
				  << "20: Sign Form - Intern form\n"
				  << "21: Be Signed - Intern form\n"
				  << "22: Execute - Intern form\n"
				  << "23: ExecuteForm - Intern form\n"
                  << "24: Exit\n" << std::endl;
        ...
        try {
            switch (test)
            {
				...
				case 19:
				{
					...
					std::string internFormName;
					std::string internTargetName;
					std::cout << "Enter the form name (Eg: Shrubbery Creation)" << std::endl;
					internFormName = getName();
					std::cout << "Enter the target" << std::endl;
					internTargetName = getName();
					f1 = intern.makeForm(internFormName, internTargetName);
					std::cout << f1 << std::endl;
					break;
				}
				...
				{
					if (!b1) {
						throw std::string("create a bureaucrat");
					}
					if (!f1) {
						throw std::string("create a form via intern");
					}
					b1->signForm(*f1);
					break;
				}
